TOOL_DECLARATIONS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "play": {
                    "type": "BOOLEAN",
                    "description": "If true, attempts to play media after opening (e.g. for Spotify)"
                },
                "query": {
                    "type": "STRING",
                    "description": "Specific song or item to search and play (use for Spotify)"
                }
            },
            "required": ["app_name"]
        }
    ...
    {
        "name": "send_message",
        "description": "Sends a text message via Telegram, Signal, Discord, Instagram, or Messenger. For WhatsApp messages, ALWAYS use the whatsapp_web tool instead — it uses the direct API link.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "receiver":     {"type": "STRING", "description": "Recipient contact name"},
                "message_text": {"type": "STRING", "description": "The message to send"},
                "platform":     {"type": "STRING", "description": "Platform: Telegram, Signal, Discord, Instagram, Messenger"}
            },
    ...
    {
        "name": "manage_memory",
        "description": "Manages JARVIS's long-term memory about the user. Use this to store facts, preferences, or personal details.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "action": {"type": "STRING", "description": "store | retrieve | get_all"},
                "key":    {"type": "STRING", "description": "The fact key (e.g. 'favorite_color')"},
    ...
    },
    {
        "name": "apify_leads",
        "description": (
            "Scrape leads or data from platforms using Apify. "
            "Common Actors & Input requirements:\n"
            "- 'compass/crawler-google-places': REQUIRES 'searchStringsArray' (list of strings, e.g. ['restaurants in London']).\n"
            "- 'apify/instagram-scraper': REQUIRES 'directUrls' (list of profile URLs).\n"
            "- 'apify/facebook-pages-scraper': REQUIRES 'searchQueries' (list of strings).\n"
            "ALWAYS use the technical field names required by the actor."
        ),
        "parameters": {
            "type": "OBJECT",
            "properties": {
                "actor_id": {
                    "type": "STRING",
                    "description": "The Apify Actor ID."
                },
                "input_data": {
                    "type": "OBJECT",
                    "properties": {
                    ...
                    "description": "Dictionary of input parameters. Use the correct technical names (e.g., 'searchStringsArray' for Google Places)."
                }
            },
    ...
    {
        "name": "whatsapp_web",
        "description": "THE primary tool for ALL WhatsApp operations. Uses direct API link (web.whatsapp.com/send?phone=) to go straight to the contact's conversation. Use for: sending any WhatsApp message, reading replies, or starting an autonomous sales loop. ALWAYS use this instead of send_message for WhatsApp.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
    ...
    },
    {
        ...
        "description": "Generates or loads a sales negotiation script for a specific product.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
                ...
                "max_discount": {"type": "STRING", "description": "Max allowed discount"},
                "tone": {"type": "STRING", "description": "Tone: formal | casual | aggressive | consultative"}
            },
    ...
    {
        "name": "notifier",
        "description": "Sends a desktop notification with a sound alert.",
        "parameters": {
            "type": "OBJECT",
            "properties": {
